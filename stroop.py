...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # Run 'Begin Experiment' code from leer_instruccion
    instrucciones_txt = ''
    ...
    texto_instrucciones.setText(instrucciones_txt)
    # create starting attributes for key_next
    key_next.keys = []
    key_next.rt = []
    _key_next_allKeys = []
    # Run 'Begin Routine' code from leer_instruccion
    instrucciones_txt = 'No se pudo cargar instrucciones.'  # valor por defecto
    try:
        with open('resources/instrucciones.txt', 'r', encoding='utf-8') as f:
            instrucciones_txt = f.read()
    except Exception as e:
        print(f'Error al leer instrucciones.txt: {e}')
